...
```javascript
import strided2array5d from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-strided2array5d@v0.2.3-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/array-base-strided2array5d/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/array-base-strided2array5d/actions/workflows/test.yml?query=branch:v0.2.3
